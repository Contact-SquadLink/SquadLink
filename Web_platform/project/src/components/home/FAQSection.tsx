...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'When the rider arrives at your location, you confirm delivery with an OTP. The rider initiates the OTP, you enter it, and the delivery is confirmed. The OTP is never generated on the frontend.',
  },
  // Businesses
  {
    category: 'Businesses',
  ...
  // Riders
  {
    ...
    answer: 'You can start by creating an account through the registration page. Rider onboarding follows the platform\'s actual authentication and registration model. Contact the team for rider-specific onboarding details.',
  },
  {
    category: 'Riders',
  ...
  },
  {
    ...
    answer: 'Riders verify pickup from the business through a dedicated pickup verification step. This is separate from the customer delivery OTP and confirms the rider has collected the order.',
  },
  {
    category: 'Riders',
